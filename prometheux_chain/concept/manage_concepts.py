...
def rename_concept(ontology_id, old_name, new_name, scope="user"):
    ...
    return _check(JarvisPyClient.rename_concept(
        ontology_id=ontology_id, old_name=old_name, new_name=new_name, scope=scope,
    ), "rename")
...
def cleanup_concepts(ontology_id, scope="user", concept_names=None):
    ...
    return _check(JarvisPyClient.cleanup_concepts(
        ontology_id=ontology_id, scope=scope, concept_names=concept_names,
    ), "cleanup")
...
def reorder_concepts(ontology_id, concept_names, scope="user", group=None):
    ...
    return _check(JarvisPyClient.reorder_concepts(
        ontology_id=ontology_id, concept_names=concept_names, scope=scope, group=group,
    ), "reorder")
...
def generate_concept_description(ontology_id, concept_name, scope="user"):
    ...
    return _check(JarvisPyClient.generate_concept_description(
        ontology_id=ontology_id, concept_name=concept_name, scope=scope,
