...
def save_ontology_schema(ontology_id, ontology_schema_data, scope="user"):
    ...
    response = JarvisPyClient.save_ontology_schema(
        ontology_id=ontology_id, ontology_schema_data=ontology_schema_data, scope=scope,
    )
    if response.get('status') != 'success':
...
def load_ontology_schema(ontology_id, scope="user"):
    ...
    return _check(JarvisPyClient.load_ontology_schema(ontology_id=ontology_id, scope=scope), "load")
